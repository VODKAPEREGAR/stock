...
class Advert(models.Model):
    ...
    description = models.TextField(max_length=256, verbose_name="Описание", blank=True)
    status = models.CharField(max_length=12, choices=advert_status, default=advert_status[1])
    #seller
    slug = models.SlugField(max_length=64)
    def __str__(self):
        return self.title